...
<body id="myPage" data-spy="scroll" data-target=".navbar" data-offset="60">
  ...
  <nav class="navbar navbar-default navbar-fixed-top" id="Navbar">
    <script src="Script\RnavBar.js"></script>
  </nav>
  ...
  <div id="about" class="container-fluid">
    <div class="row">
      <h2>Ingrese la informacion que se le pide</h2>
      <form action="includes/signup.inc.php" method="post">
        ...
        <div class="form-floating md-form">
          <input type="text" name="name" class="form-control mb-4" placeholder="Nombre Completo">
        ...
        <div class="form-floating md-form">
          <input type="password" name="pwdrepeat" class="form-control mb-4" placeholder="Confirmar Contraseña">
          <label for="floatingInput">Confirmar Contraseña</label>
        </div>
        <button type="submit" name="submit" class="btn btn-dark btn-block">Registrarse</button><br><br>
      </form>
    </div>
  </div>
  <div class="error-handler">
    ...
    if(isset($_GET["error"])){
      if($_GET["error"] == "emptyinput"){
          ...
          <div class="alert alert-danger">
          <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
          <strong>Error:</strong> El ID de usuario elegido ya existe. Por favor elige otro
        </div>
          ';
